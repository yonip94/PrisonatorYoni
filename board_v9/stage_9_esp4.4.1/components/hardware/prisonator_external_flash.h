...
#define EXTERNAL_FLASH_WRITE_CODE_QSPI              ((uint8_t)0x32)
#define EXTERNAL_FLASH_READ_CODE_FAST_QSPI          ((uint8_t)0x6B)
...
/*******************************************************************/
    ...
    void    external_flash_read_test                    (uint32_t record_number, uint8_t* data, uint32_t size, uint32_t index);//read 850 bytes takes 2.5ms 
