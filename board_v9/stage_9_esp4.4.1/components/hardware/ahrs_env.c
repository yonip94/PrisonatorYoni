...
/*******************************************************************/
/*******************************************************************/
static ahrs_data_out_t g_ahrs_data_out = {0};
...
esp_err_t AHRS_ENV_input(ahrs_data_in_t ahrs_data_in)
{
    ...
    ESP_LOGI(TAG_AHRS, "[IN] acc_bias_x             = %f", ahrs_data_in.acc_bias_x);
    ESP_LOGI(TAG_AHRS, "[IN] acc_bias_y             = %f", ahrs_data_in.acc_bias_y);
    ESP_LOGI(TAG_AHRS, "[IN] acc_bias_z             = %f", ahrs_data_in.acc_bias_z);
    ESP_LOGI(TAG_AHRS, "[IN] acc_sf_x               = %f", ahrs_data_in.acc_sf_x);
    ESP_LOGI(TAG_AHRS, "[IN] acc_sf_y               = %f", ahrs_data_in.acc_sf_y);
    ESP_LOGI(TAG_AHRS, "[IN] acc_sf_z               = %f", ahrs_data_in.acc_sf_z);
    ESP_LOGI(TAG_AHRS, "[IN] gyro_drift_x           = %f", ahrs_data_in.gyro_drift_x);
    ESP_LOGI(TAG_AHRS, "[IN] gyro_drift_y           = %f", ahrs_data_in.gyro_drift_y);
    ESP_LOGI(TAG_AHRS, "[IN] gyro_drift_z           = %f", ahrs_data_in.gyro_drift_z);
