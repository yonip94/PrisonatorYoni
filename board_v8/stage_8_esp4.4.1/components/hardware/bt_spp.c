...
esp_err_t bt_send_data(uint8_t* bt_data, uint32_t size)
{
    ...
    if (bt_state != BT_ENABLED_AND_CONNECTED) 
    {
        ...
        acc_x_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_1]<<8)   | bt_data[BT_PACKET_OFFET_IMU_SET_1+1]));
        acc_y_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_1+2]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_1+3]));
        acc_z_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_1+4]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_1+5]));
        ...
        memcpy (&ts_imu,bt_data + BT_PACKET_OFFET_IMU_SET_1 + (BT_PACKET_IMU_SET_SIZE - TIMESTAMP_BYTES_NUM),TIMESTAMP_BYTES_NUM);
        ...
        acc_x_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_2]<<8)   | bt_data[BT_PACKET_OFFET_IMU_SET_2+1]));
        acc_y_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_2+2]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_2+3]));
        acc_z_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_2+4]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_2+5]));
        ...
        acc_x_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_3]<<8)   | bt_data[BT_PACKET_OFFET_IMU_SET_3+1]));
        acc_y_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_3+2]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_3+3]));
        acc_z_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_3+4]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_3+5]));
        ...
        acc_x_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_4]<<8)   | bt_data[BT_PACKET_OFFET_IMU_SET_4+1]));
        acc_y_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_4+2]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_4+3]));
        acc_z_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_4+4]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_4+5]));
        ...
        acc_x_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_5]<<8)   | bt_data[BT_PACKET_OFFET_IMU_SET_5+1]));
        acc_y_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_5+2]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_5+3]));
        acc_z_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_5+4]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_5+5]));
        ...
        acc_x_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_6]<<8)   | bt_data[BT_PACKET_OFFET_IMU_SET_6+1]));
        acc_y_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_6+2]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_6+3]));
        acc_z_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_6+4]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_6+5]));
        ...
        gyr_x_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_1+6]<<8)   | bt_data[BT_PACKET_OFFET_IMU_SET_1+6+1]));
        gyr_y_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_1+6+2]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_1+6+3]));
        gyr_z_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_1+6+4]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_1+6+5]));
        ...
        gyr_x_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_2+6]<<8)   | bt_data[BT_PACKET_OFFET_IMU_SET_2+6+1]));
        gyr_y_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_2+6+2]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_2+6+3]));
        gyr_z_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_2+6+4]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_2+6+5]));
        ...
        gyr_x_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_3+6]<<8)   | bt_data[BT_PACKET_OFFET_IMU_SET_3+6+1]));
        gyr_y_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_3+6+2]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_3+6+3]));
        gyr_z_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_3+6+4]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_3+6+5]));
        ...
        gyr_x_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_4+6]<<8)   | bt_data[BT_PACKET_OFFET_IMU_SET_4+6+1]));
        gyr_y_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_4+6+2]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_4+6+3]));
        gyr_z_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_4+6+4]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_4+6+5]));
        ...
        gyr_x_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_5+6]<<8)   | bt_data[BT_PACKET_OFFET_IMU_SET_5+6+1]));
        gyr_y_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_5+6+2]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_5+6+3]));
        gyr_z_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_5+6+4]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_5+6+5]));
        ...
        gyr_x_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_6+6]<<8)   | bt_data[BT_PACKET_OFFET_IMU_SET_6+6+1]));
        gyr_y_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_6+6+2]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_6+6+3]));
        gyr_z_bytes = (uint16_t)(((uint16_t)(bt_data[BT_PACKET_OFFET_IMU_SET_6+6+4]<<8) | bt_data[BT_PACKET_OFFET_IMU_SET_6+6+5]));
        ...
        memcpy(&baro_pressure_float,bt_data + BT_PACKET_OFFET_BARO_PRESSURE_VAL, 4); 
        memcpy(&baro_temp_float, bt_data + BT_PACKET_OFFET_BARO_TEMP_VAL, 4);
        //printf("Baro: Pressure = %f, Temp = %f\r\n",baro_pressure_float, baro_temp_float);

        memcpy (&ts_mmc,bt_data + BT_PACKET_OFFET_MMC_SET_1 + (BT_PACKET_MMC_SET_SIZE - TIMESTAMP_BYTES_NUM),TIMESTAMP_BYTES_NUM);
        //printf("MMC set1 TS = %llu\r\n",ts_mmc);

        memcpy(&mmc_x_float, bt_data + BT_PACKET_OFFET_MMC_SET_1, 4);
        memcpy(&mmc_y_float, bt_data + BT_PACKET_OFFET_MMC_SET_1 + 4, 4);
        memcpy(&mmc_z_float, bt_data + BT_PACKET_OFFET_MMC_SET_1 + 8, 4);
        printf("MMC set1: X=%f, Y=%f, Z=%f\r\n",mmc_x_float, mmc_y_float, mmc_z_float);

        memcpy(&mmc_x_float, bt_data + BT_PACKET_OFFET_MMC_SET_2, 4);
        memcpy(&mmc_y_float, bt_data + BT_PACKET_OFFET_MMC_SET_2 + 4, 4);
        memcpy(&mmc_z_float, bt_data + BT_PACKET_OFFET_MMC_SET_2 + 8, 4);
        printf("MMC set2: X=%f, Y=%f, Z=%f\r\n",mmc_x_float, mmc_y_float, mmc_z_float);

        memcpy (&ts_mmc,bt_data + BT_PACKET_OFFET_MMC_SET_3 + (BT_PACKET_MMC_SET_SIZE - TIMESTAMP_BYTES_NUM),TIMESTAMP_BYTES_NUM);
        //printf("MMC set3 TS = %llu\r\n",ts_mmc);

        memcpy(&mmc_x_float, bt_data + BT_PACKET_OFFET_MMC_SET_3, 4);
        memcpy(&mmc_y_float, bt_data + BT_PACKET_OFFET_MMC_SET_3 + 4, 4);
        memcpy(&mmc_z_float, bt_data + BT_PACKET_OFFET_MMC_SET_3 + 8, 4);
        printf("MMC set3: X=%f, Y=%f, Z=%f\r\n",mmc_x_float, mmc_y_float, mmc_z_float);

        memcpy(&mmc_x_float, bt_data + BT_PACKET_OFFET_MMC_SET_4, 4);
        memcpy(&mmc_y_float, bt_data + BT_PACKET_OFFET_MMC_SET_4 + 4, 4);
        memcpy(&mmc_z_float, bt_data + BT_PACKET_OFFET_MMC_SET_4 + 8, 4);
...
static void esp_spp_cb_L(esp_spp_cb_event_t event, esp_spp_cb_param_t *param)
{
    uint64_t start_time_catch_cong = 0;
